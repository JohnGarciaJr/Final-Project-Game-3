...
function appendNewCard(parentElement) {
  ...
  var newCard = parentElement.appendChild(document.createElement("div"));
  ...
  let cardDown = newCard.appendChild(document.createElement("div"));
  cardDown.classList.add("card-down");
  let cardUp = newCard.appendChild(document.createElement("div"));
...
function shuffleCardImageClasses() {
  ...
  let shuffledCardImages = ["image-1", "image-1", "image-2", "image-2", "image-3", "image-3", "image-4", "image-4", "image-5", "image-5", "image-6", "image-6"];
   ...
   */
  result = _.shuffle(shuffledCardImages)
  // console.log(result)
...
let clickAudio = new Audio('audio/charge.wav');
let matchAudio = new Audio('audio/niceworkkid.wav');
let winAudio = new Audio('audio/ironmanwins.wav')
...
function onCardFlipped(newlyFlippedCard) {
  ...
  incrementCounter("flip-counter", flipCounter);
